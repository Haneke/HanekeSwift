...
class UIImageView_HanekeTests: XCTestCase {
    ...
    func testFormatWithSize() {
        ...
        let format = Haneke.UIKitGlobals.hnk_formatWithSize(size, scaleMode: scaleMode)
    ...
    func testFormatWithSize_Twice() {
        ...
        let scaleMode = ImageResizer.ScaleMode.Fill
        let cache = Haneke.sharedImageCache
        let format1 = Haneke.UIKitGlobals.hnk_formatWithSize(size, scaleMode: scaleMode)
        let image = UIImage.imageWithColor(UIColor.greenColor())
        cache.addFormat(format1)
        cache.set(value: image, key: self.name, formatName: format1.name)
        
        let format2 = Haneke.UIKitGlobals.hnk_formatWithSize(size, scaleMode: scaleMode)
